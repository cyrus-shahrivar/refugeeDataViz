...
window.onload = function() {
    ...
    var drawnOrderStatesNumberArray = [47, 26, 12, 34, 23, 19, 22, 49, 37, 41, 29, 45, 32, 50, 15, 27, 21, 13,
        38, 6, 39, 4, 44, 28, 35, 14, 30, 5, 48, 25,16, 7, 20, 46, 17, 8, 2, 36, 31, 42, 33, 43, 3, 40, 0, 10,
        24, 18, 9, 11, 1
    ];
      ...
      // getting data from refugee json files, pushing data to arrays
            ...
            d3.json("data/" + dataset + ".json", function(error, data) {
                ...
                var populateCountriesAndStates = function() {
                        ...
                        topTenCountries = produceTopTenCountries(data);
                ...
                d3.select("body > div > div.left-container > div > li:nth-child(" + (country + 1) + ")").style({
                    "text-decoration": "underline",
                    "font-weight": "bold",
                    "color": "black"
                });
    ...
    d3.select("#years-list").selectAll("li")
        ...
        .on("click", function(d, i) {
            ...
            d3.json("data/" + d + "_refugees.json", function(error, data) {
...
function produceTopTenCountries(data) {
    // unique zips up columns and totals for each country
